...
public class ViewPayStub extends Application {
    ...
    public ViewPayStub(Employee e) {
        this.employee = e;
        this.addHours = employee.getAddHours();
    ...
    public ViewPayStub() {
        ...
        // Set default hours for testing
        addHours.setHours(0, 8.0);
        addHours.setHours(1, 12.3);
        addHours.setHours(2, 10.0);
        addHours.setHours(3, 12.3);
        addHours.setPTO(4, pto);
        addHours.setHours(5, 0.0);
        addHours.setHours(6, 2.0);
    }
    ...
    public String[] generatePayStub(Employee e) {
        AddHours ah = e.getAddHours();
        PTO pto = e.getPTO();
    ...
    public VBox createPayStubLayout(String[] payStubData, Employee employee) {
    ...
    public void start(Stage primaryStage) {
        String[] payStub = generatePayStub(employee);
